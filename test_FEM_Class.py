...
#         result=self.get_result(material_model,config_mesh,out_file_name,SOLVER_METHOD)
...
#-----------------------------------------------------------------------------# 
    ...
    def test_normal_stress_X_cantielever_2D(self):
        ...
        np.savetxt('result_cantielever_2D_stress_X.csv', result['stress_nodes'][:,0], delimiter=',')
...
#-----------------------------------------------------------------------------# 
    ...
    def get_result(self,material_model,config_mesh,out_file_name,SOLVER_METHOD):
