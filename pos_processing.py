...
import meshio
import numpy as np
def pos_static_linear(B_all_elem,tang_modu,stress_gauss_all,
    ...
    stress_gauss_all,strain_gauss=material_model.get_stress_and_strain(B_all_elem,
              tang_modu,stress_gauss_all,strain_gauss,connectivity,n_nodes_elem,
                      n_Gauss_elem,DOF_node_elem,displacement,u_elem,n_elem)
   
    #Stress and strain extrapolated 
    stress_nodes,strain_nodes=element.extrapolate_stress_strain(stress_gauss_all,strain_gauss,
    ...
    return stress_gauss_all,strain_gauss,stress_nodes,strain_nodes
